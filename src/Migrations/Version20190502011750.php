 ...
 */
final class Version20190502011750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, issn VARCHAR(50) NOT NULL, name VARCHAR(255) NOT NULL, status ENUM(\'new\', \'pending\', \'in review\', \'approved\', \'inactive\', \'deleted\') DEFAULT \'new\', created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_D34A04AD9FC5D7F6 (issn), INDEX IDX_D34A04AD9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
